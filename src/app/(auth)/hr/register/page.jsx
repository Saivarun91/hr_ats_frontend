...
export default function HRRegister() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        company_password: form.company_password
      };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 mt-16 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
          <h1 className="text-2xl font-bold">HR Registration</h1>
          <p className="text-blue-100 text-sm mt-2">Create your HR account</p>
        </div>
        ...
        <div className="p-6">
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <div>
              <label htmlFor="company_password" className="block text-sm font-medium text-gray-700 mb-1">
                Company Password
              </label>
              <input
                id="company_password"
                ...
                onChange={(e) => setForm({...form, company_password: e.target.value})}
                required
              />
            </div>
            ...
            {success && (
              <div className="bg-green-50 text-green-700 p-3 rounded-lg text-sm flex items-start">
                <svg className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.707 7.293a1 1 0 00-1.414 1.414L10.586 10l-1.293 1.293a1 1 0 101.414 1.414L12 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd"></path>
                </svg>
                <span>{success}</span>
              </div>
            )}
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <p className="text-xs text-gray-600 text-center">
              ...
              <Link href="/hr/login" className="text-blue-600 hover:text-blue-800 font-medium">
                Login here
              </Link>
            </p>
          </div>
